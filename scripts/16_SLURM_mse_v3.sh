...
#SBATCH --output=/SCRATCH/TIC117/cmg/alejandro/mse_analysis/logs/mse_analysis-%j.out
#SBATCH --error=/SCRATCH/TIC117/cmg/alejandro/mse_analysis/logs/mse_analysis-%j.err
...
mkdir -p /SCRATCH/TIC117/cmg/alejandro/mse_analysis/logs
mkdir -p "$OUTPUT_DIR"
